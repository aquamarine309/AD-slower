...
export const GameStorage = {
  ...
  get localStorageKey() {
    return DEV ? "dimensionSlowerTestSave" : "dimensionSlowerSave";
  },

  backupDataKey(saveSlot, backupSlot) {
    return DEV ? `backupSlowerTestSave-${saveSlot}-${backupSlot}` : `backupSlowerSave-${saveSlot}-${backupSlot}`;
  },

  backupTimeKey(saveSlot) {
    return DEV ? `backupSlowerTestTimes-${saveSlot}` : `backupSlowerTimes-${saveSlot}`;
  },
