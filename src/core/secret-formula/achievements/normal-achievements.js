...
export const normalAchievements = [
  {
    ...
    get reward() { return "Small multiplier to Antimatter Dimensions based on current antimatter."; },
    effect: () => 2 * Math.sin(Currency.antimatter.value.add(1).log10() / 3 - 1.57) + 2.1,
    formatEffect: value => formatX(value, 3, 4),
  ...
  },
  {
    ...
    reward: "Disable max all hotkey. All dimension multipliers divide the amount of Dimension Boosts.",
    effect: () => Math.max(1, DimBoost.purchasedBoosts),
  ...
  },
  {
    ...
    reward: "If you don't buy the newest dimension, the multiplier of all dimensions is halved.",
    effect: 0.5,
    effectCondition: () => AntimatterDimension(DimBoost.requirement.tier).amount.eq(0),
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
    id: 21,
    ...
    get reward() { return `Start with ${formatInt(100)} antimatter. Restoring the ability to max all hotkey`; },
    effect: 100
  },
  {
    id: 22,
  ...
  },
  {
    ...
    get reward() { return `8th Antimatter Dimensions are ${formatPercents(0.1)} weaker.`; },
    effect: 0.9
  },
  {
    id: 24,
  ...
  },
  {
    ...
    checkRequirement: () => true,
    get reward() { return `Game runs ${formatX(2)} faster.`; },
    effect: 2,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
    get reward() { return `1st Antimatter Dimensions are ${formatPercents(0.1)} weaker.`; },
    effect: 0.9
  },
  {
    id: 31,
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() { return `1st Antimatter Dimensions are ${formatPercents(0.05)} weaker.`; },
    effect: 0.95
  },
  {
    id: 32,
    name: "The Gods are pleased",
    get description() { return `Get over ${formatX(610)} from Dimensional Sacrifice outside of Challenge 8.`; },
    checkRequirement: () => !NormalChallenge(8).isOnlyActiveChallenge && Sacrifice.totalBoost.gte(610),
  ...
  },
  {
    ...
    description:
      ...
      " second highest, etc. with broken Infinity.",
    checkRequirement: () => {
